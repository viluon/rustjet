...
pub struct FormQuestion {
    ...
    pub question_id: i32,
    #[serde(rename = "type")]
    pub r#type: models::FormQuestionType,
    ...
    pub options: Option<Vec<models::FormAnswer>>,
}

impl FormQuestion {
    pub fn new(question_id: i32, r#type: models::FormQuestionType, text: String) -> FormQuestion {
        FormQuestion {
            question_id,
            r#type,
            text,
