...
pub struct SimpleRouteDetail {
    ...
    pub credit_price_from: Option<f64>,
    ...
    pub vehicle_types: Option<Vec<models::VehicleType>>,
    #[serde(rename = "priceClasses", skip_serializing_if = "Option::is_none")]
    pub price_classes: Option<Vec<models::PriceClass>>,
    #[serde(rename = "surcharge", skip_serializing_if = "Option::is_none")]
    pub surcharge: Option<Box<models::Surcharge>>,
