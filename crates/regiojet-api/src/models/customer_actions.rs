...
pub struct CustomerActions {
    ...
    #[serde(rename = "requiredToFillInQuestionnaire")]
    pub required_to_fill_in_questionnaire: bool,
}
...
impl CustomerActions {
    ...
    pub fn new(
        ...
        storno: bool,
        rebook: bool,
        edit_passengers: bool,
        additional_services: bool,
        sent_to_mail: bool,
        print_ticket: bool,
        print_invoice: bool,
        required_to_fill_in_questionnaire: bool,
    ) -> CustomerActions {
        CustomerActions {
            show_detail,
            pay,
            ...
            print_ticket,
            print_invoice,
            required_to_fill_in_questionnaire,
        }
    }
}
