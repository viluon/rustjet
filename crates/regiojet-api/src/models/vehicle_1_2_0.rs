...
pub struct Vehicle120 {
    ...
    #[serde(rename = "vehicleSeatClasses")]
    pub vehicle_seat_classes: Vec<models::VehicleSeatClass>,
...
impl Vehicle120 {
    pub fn new(
        ...
        vehicle_number: i32,
        vehicle_seat_classes: Vec<models::VehicleSeatClass>,
