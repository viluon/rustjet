...
pub async fn get_time_ticket_price(
...
) -> Result<Vec<models::TimeTicketPrice>, Error<GetTimeTicketPriceError>> {
    ...
    let uri_str = format!(
        ...
        validFrom = crate::apis::urlencode(p_path_valid_from),
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetTimeTicketPriceError> = serde_json::from_str(&content).ok();
