...
/// TicketAffiliate : expirationDate is date-time value states when ticket expires. ExpiresAt states how many days, hours and minutes left to ticket expiration.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TicketAffiliate {
    /// ID of the ticket
    #[serde(rename = "id")]
    pub id: i64,
