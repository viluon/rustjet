...
pub struct TimeTicket {
    ...
    pub customer_actions: Box<models::TimeTicketCustomerAction>,
    #[serde(rename = "conditions")]
    pub conditions: Box<models::PriceConditions>,
    #[serde(rename = "bills", skip_serializing_if = "Option::is_none")]
    pub bills: Option<Vec<models::TimeTicketBill>>,
}
...
impl TimeTicket {
    ...
    pub fn new(
        ...
        seat_class: models::SeatClass,
        valid_from: String,
        customer_actions: models::TimeTicketCustomerAction,
