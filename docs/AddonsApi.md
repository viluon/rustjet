...
> Vec<models::AvailableAddon> get_available_addons(request, x_application_origin, x_lang, x_currency)
...
> models::SuccessResponse order_addons(ticket_id, order_addons_request, x_application_origin, x_lang)
...
> models::SuccessResponse verify_addons(addons_verify_request, x_application_origin, x_lang, x_currency)
