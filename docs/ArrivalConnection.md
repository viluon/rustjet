...
**stations** | Option<[**Vec<models::ArrivalConnectionStation>**](ArrivalConnectionStation.md)> | Individual stations (including metadata) sort according to order which connection builds. | [optional]
